...
//        listView_Contacts.setAdapter(new ArrayAdapter<Person>(this, android.R.layout.simple_list_item_1, people));
    ...
    private ArrayList<HashMap<String, String>> createDummyPeople() {
        ...
        people.add(createMapFromPerson(new Person("Pero Perić", "098 181 24 33", "pero.peric@gmail.com")));
        people.add(createMapFromPerson(new Person("Ivo Ivić", "098 181 24 33", "ivo.peric@gmail.com")));
        people.add(createMapFromPerson(new Person("Marko Marković", "098 181 24 33", "marko.peric@gmail.com")));
        return people;
    }

    private HashMap<String, String> createMapFromPerson(Person p) {
